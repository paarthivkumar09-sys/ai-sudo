import { c as createLucideIcon, j as jsxRuntimeExports, a as cn, k as commonjsGlobal, l as getDefaultExportFromCjs, r as reactExports, m as clsx, R as React, n as invariant, S as Skeleton, L as Link } from "./index-Ai3gszGZ.js";
import { B as Badge } from "./badge-qebL2BM0.js";
import { b as useAnalytics, e as useSystemHealth } from "./use-backend-Cq3ihEoA.js";
...
import { C as Clock } from "./clock-BX51TAam.js";
/**
    ...
    Card,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `${accentClass} opacity-80`, children: icon })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `text-3xl font-display font-bold ${accentClass}`, children: value }),
          pulse && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "mb-1 flex items-center gap-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block w-2 h-2 rounded-full bg-amber-500 animate-pulse" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-amber-500 font-mono", children: "live" })
          ] })
        ] }),
...
function DonutCenterLabel({
  ...
  const cx = (viewBox == null ? void 0 : viewBox.cx) ?? 0;
  const cy = (viewBox == null ? void 0 : viewBox.cy) ?? 0;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("text", { x: cx, y: cy, textAnchor: "middle", dominantBaseline: "middle", children: [
...
function formatUptime(nanos) {
  const seconds = Number(nanos / 1000000000n);
...
function Analytics() {
  const { data: analytics, isLoading: analyticsLoading } = useAnalytics(1e4);
  const { data: health, isLoading: healthLoading } = useSystemHealth(5e3);
  ...
  const outcomeBarData = analytics ? [
    {
      name: "Auto-allowed",
      value: Number(analytics.greenCommands) + Number(analytics.yellowCommands),
  ...
  const disastersPrevented = Number((analytics == null ? void 0 : analytics.disastersPrevented) ?? 0n);
  const pendingCount = Number((health == null ? void 0 : health.pendingApprovals) ?? 0n);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-2xl font-bold text-foreground tracking-tight", children: "Analytics & System Health" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-0.5", children: "Real-time overview of AI governance activity" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Badge,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse mr-1.5" }),
                "Live"
              ]
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { "data-ocid": "analytics.metrics.section", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xs font-mono text-muted-foreground uppercase tracking-widest mb-3", children: "Key Metrics" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-4", children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(MetricsSkeleton, { count: 4 }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              MetricCard,
              {
                ocid: "analytics.total_commands.card",
                label: "Total Commands",
                value: Number((analytics == null ? void 0 : analytics.totalCommands) ?? 0n).toLocaleString(),
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      ...
                      style: {
                        background: "radial-gradient(circle at 80% 20%, #ef4444 0%, transparent 70%)"
                      }
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between relative", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-mono text-muted-foreground uppercase tracking-widest", children: "Disasters Prevented" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Shield, { size: 18, className: "text-red-400 opacity-80" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-3xl font-display font-bold text-red-400", children: disastersPrevented.toLocaleString() }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground relative", children: "Rejected + blocked critical actions" })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              MetricCard,
              {
                ...
                label: "Auto-Executed",
                value: (Number((analytics == null ? void 0 : analytics.greenCommands) ?? 0n) + Number((analytics == null ? void 0 : analytics.yellowCommands) ?? 0n)).toLocaleString(),
                subtext: "Green + yellow commands",
                icon: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { size: 18 }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { "data-ocid": "analytics.charts.section", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xs font-mono text-muted-foreground uppercase tracking-widest mb-3", children: "Risk Distribution" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-border bg-card p-5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-sm text-foreground mb-4", children: "Risk Level Ratio" }),
              isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-56 w-full rounded-lg" }) : riskPieData.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-56 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "No command data yet" }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 220, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(PieChart, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  Pie,
                  {
                    data: riskPieData,
                    ...
                    endAngle: -270,
                    children: [
                      riskPieData.map((entry) => /* @__PURE__ */ jsxRuntimeExports.jsx(Cell, { fill: entry.color, stroke: "none" }, entry.name)),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(DonutCenterLabel, {})
                    ]
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Legend,
                  {
                    iconType: "circle",
                    iconSize: 8,
                    formatter: (value) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "oklch(0.52 0 0)", fontSize: 12 }, children: value })
                  }
                )
              ] }) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-border bg-card p-5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-sm text-foreground mb-4", children: "Command Outcomes" }),
              isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-56 w-full rounded-lg" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 220, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                BarChart,
                {
                  data: outcomeBarData,
                  barSize: 36,
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "value", radius: [4, 4, 0, 0], children: outcomeBarData.map((entry) => /* @__PURE__ */ jsxRuntimeExports.jsx(Cell, { fill: entry.fill }, entry.name)) })
                  ]
                }
              ) })
            ] })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { "data-ocid": "analytics.health.section", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xs font-mono text-muted-foreground uppercase tracking-widest mb-3", children: "System Health" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-4", children: healthLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(MetricsSkeleton, { count: 4 }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Card,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-mono text-muted-foreground uppercase tracking-widest", children: "Active Agents" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { size: 16, className: "text-cyan-400 opacity-70" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-3xl font-display font-bold text-cyan-400", children: Number((health == null ? void 0 : health.activeAgents) ?? 0n).toLocaleString() }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "AI agents connected" })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Card,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-mono text-muted-foreground uppercase tracking-widest", children: "Requests / min" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Activity, { size: 16, className: "text-primary opacity-70" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end gap-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-3xl font-display font-bold text-foreground", children: ((health == null ? void 0 : health.requestsPerMinute) ?? 0).toFixed(1) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "mb-1 flex items-center gap-1", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block w-2 h-2 rounded-full bg-cyan-500 animate-pulse" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-cyan-500 font-mono", children: "live" })
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Averaged over last minute" })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Card,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-mono text-muted-foreground uppercase tracking-widest", children: "Pending Approvals" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      TriangleAlert,
                      {
                        size: 16,
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-3xl font-display font-bold text-amber-400", children: Number((health == null ? void 0 : health.pendingApprovals) ?? 0n).toLocaleString() }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Link,
                    {
                      to: "/dashboard",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Card,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-mono text-muted-foreground uppercase tracking-widest", children: "Uptime" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { size: 16, className: "text-emerald-400 opacity-70" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-3xl font-display font-bold text-emerald-400", children: health ? formatUptime(health.uptime) : "—" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Since last deployment" })
                ]
              }
            )
          ] }) })
